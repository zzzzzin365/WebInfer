/**
 * WebInfer - Question Answering Pipeline
 * 
...
> {
  ...
  private async answerQuestion(
    ...
    const startLogits = (outputs[0] as WebInferTensor).toFloat32Array();
    const endLogits = (outputs[1] as WebInferTensor).toFloat32Array();
