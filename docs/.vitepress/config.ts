...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Cookbook', link: '/cookbook/transformers-adapter' },
      {
        ...
        items: [
          ...
          { text: 'GitHub', link: 'https://github.com/nicepkg/WebInfer' },
        ],
      },
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/nicepkg/WebInfer' },
      { icon: 'npm', link: 'https://www.npmjs.com/package/webinfer' },
    ],
    ...
    footer: {
      ...
      copyright: 'Copyright 2026 WebInfer Contributors',
    },
  },
});
