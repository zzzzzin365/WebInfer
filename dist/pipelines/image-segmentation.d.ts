...
export declare class ImageSegmentationPipeline extends BasePipeline<ImageInput, ImageSegmentationResult> {
     ...
     */
    protected preprocess(input: ImageInput): Promise<WebInferTensor[]>;
    /**
     * Postprocess (required by BasePipeline)
     */
    protected postprocess(_outputs: WebInferTensor[], _options?: PipelineOptions): Promise<ImageSegmentationResult>;
    /**
     * Dispose resources
     */
    clearImage(): void;
