...
export class OfflineManager {
    ...
    async registerServiceWorker() {
        ...
        try {
            ...
            console.log('WebInfer service worker registered:', registration.scope);
            // Handle updates
                ...
                if (newWorker) {
                    newWorker.onstatechange = () => {
                        if (newWorker.state === 'installed' && navigator.serviceWorker.controller) {
                            console.log('New WebInfer service worker available');
                        }
                    };
                }
            };
 ...
 */
export function generateManifest(options = { name: 'WebInfer App' }) {
    return {
        name: options.name,
        short_name: options.shortName ?? options.name,
        description: options.description ?? 'ML-powered application built with WebInfer',
        start_url: '/',
        display: 'standalone',
