...
export function tensorData(serialized) {
    switch (serialized.dtype) {
        case 'float32':
        case 'float16': return new Float32Array(serialized.data);
        ...
        case 'uint8':
        case 'bool': return new Uint8Array(serialized.data);
