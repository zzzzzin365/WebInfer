...
This directory contains performance benchmarks for WebInfer.
...
## How WebInfer Adds Value

WebInfer is not a replacement for inference engines like ONNX Runtime or transformers.js. It is an **orchestration layer** that adds production features on top of them:

| Scenario | Without WebInfer | With WebInfer |
|----------|---------------------|------------------|
...
```typescript
import { runBenchmark, benchmarkSuite } from 'webinfer/tools';
