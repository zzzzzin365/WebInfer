...
const sam = {
  ...
  async loadModels() {
    ...
    try {
      // Create pipeline
      state.samPipeline = WebInfer.createImageSegmentationPipeline();
...
const chat = {
  ...
  async loadModel() {
    ...
    try {
      ...
      // Create pipeline
      state.chatPipeline = WebInfer.createTextGenerationPipeline();
...
async function init() {
  ...
  console.log('✓ WebInfer Demo initialized');
}
