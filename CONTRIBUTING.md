# Contributing to WebInfer

Thank you for your interest in contributing to WebInfer! This guide will help you get started.

## Development Setup

```bash
# Clone the repository
git clone https://github.com/nicepkg/WebInfer.git
cd WebInfer
...
WebInfer is designed as an **orchestration layer**, not an inference engine. Key principles:
